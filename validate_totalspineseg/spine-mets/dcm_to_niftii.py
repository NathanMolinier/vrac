"""
Copied from https://github.com/rouge1616/Spine-Mets-CT-SEG/blob/main/tcia_dcm2nifti.py
"""
import os
import subprocess
...
if __name__ == "__main__":
    input_folder = "/home/ge.polymtl.ca/p118739/data/datasets/Spine-Mets-CT/manifest-1724965242274/Spine-Mets-CT-SEG"  # Replace with the path to the input folder
    output_folder = "/home/ge.polymtl.ca/p118739/data/datasets/Spine-Mets-CT/manifest-1724965242274/Spine-Mets-CT-SEG-Nifti"  # Replace with the path for the output
    path_to_segimage2itkimage = "/home/ge.polymtl.ca/p118739/.conda/envs/tss_env/lib/python3.10/site-packages/dcmqi/bin/segimage2itkimage"
