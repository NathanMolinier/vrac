        ...
        "GeneratedBy": [
            {
                ...
                "Version": "v2.0.4",
                "Description": "Automatically generated by Yehuda Warszawer",
            ...
            for file_name in os.listdir(path_sub_der_dir):
                if '.nii.gz' in file_name:
                    ...
                    if '_seg' in file_name:
                        ...
                        label_sacrum = zeros_like(label)
                        label_sacrum.data[np.where(label.data==sacrum_val)] = 1
                        label.data[np.where(label.data==sacrum_val)] = 0
                        ...
                        # Save files
                        sacrum_path = file_path.replace('_seg', '_label-sacrum_seg')
                        multi_path = file_path.replace('_seg', '_label-mutli_dseg')
                        label_sacrum.save(sacrum_path)
                        label.save(multi_path)
                        create_json_file(sacrum_path)
